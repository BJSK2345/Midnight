...
const navItems = [
  { id: 'chat', label: 'Chat', icon: 'M4 6h16M4 12h11M4 18h8' },
  { id: 'twins', label: 'Digital Twins', icon: 'M6 7l6-3 6 3v10l-6 3-6-3V7zm6 3v10m-6-13l6 3 6-3' },
  { id: 'settings', label: 'Settings', icon: 'M12 8.5a3.5 3.5 0 100 7 3.5 3.5 0 000-7zm0-5v3m0 11v3m8.66-15l-2.12 2.12M5.46 18.54l-2.12 2.12m17.32 0l-2.12-2.12M5.46 5.46L3.34 3.34' },
];
